...
"""
Reason why there are two datasets, data_x and data_y
Suppose the dataset represents hourly temperature readings, and you're training a model to predict the next 24 hours based on the past 48 hours.
data_x might hold the temperature readings for the past 48 hours (input to the model).
